...
- **Guarantee:** we guarantee only what we control (citation presence, ranking movement, content volume, hours removed, agent task volume, delivery against spec). We do **not** guarantee revenue, closed deals, or conversion rate. The remedy is our labor, never a refund. One metric per engagement, named in writing, with a documented baseline before work begins, a defined window (typically 90 days), and one agreed source of truth. The window **pauses** (never voids) when a client misses an agreed, dated condition (approval turnaround, access to systems/accounts named at kickoff, information only they hold, one named point of contact); each pause is documented on the Receipt with start and end dates. See Foundation Section 9.
...
- **Proof (the only approved names):** HALT Fire and Doughbrik's Wavers (ongoing retainer clients), The Decal Dudes and Karlo Financial (current clients on project work), and Kinetix. **Kinetix is a partner, not a client.** HALT Fire's published figures are the Google Search Console numbers used across the site: search clicks up 689% to 505 and impressions up 1,608% to 22.9K over three months, plus 10+ hours a week returned. The Decal Dudes (commercial trailer services) and Karlo Financial (financial services) have no published metrics yet; keep their copy qualitative. Never add a name, a client count, a headcount, or a revenue figure.
