...
3. **CLAUDE.md rule violations**: check the diff against every applicable rule.
   ...
   Doughbrik's Wavers, The Decal Dudes, Karlo Financial, and Kinetix, with
   Kinetix labeled a partner rather than a client; canonical pricing and company facts per `SYNTREX_FOUNDATION.md`
